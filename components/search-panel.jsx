...
export function SearchPanel() {
  ...
  return (
    <section className="card rounded-3xl border border-slate-800 bg-slate-950/70 p-5 sm:p-6">
      <div className="mb-4">
      ...
      <input
        ...
        className="w-full rounded-2xl border border-slate-700 bg-slate-900 px-4 py-3 text-white outline-none ring-0 placeholder:text-slate-500 focus:border-emerald-400"
      />

      <div className="mt-5 space-y-4">
        {!debounced && (
          <div className="rounded-2xl border border-dashed border-slate-700 p-4 text-sm text-slate-400">
            Example: mercy, guidance, المؤمنين
          </div>
        )}
        ...
        {results.map((result) => (
          ...
          >
            ...
            <p className="mt-3 text-base leading-8 text-slate-300">
              {highlightText(result.translation, debounced)}
            </p>
